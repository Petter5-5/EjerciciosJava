...
public class Hitbox 
{
    ...
    public static boolean colision(Bala d, Jugador j2)
    {
        boolean resultado = false;
    ...
    public static ArrayList<Point> getPuntosMuestra(Bala d)
    {
        int x = d.getX();
        int y = d.getY();
        int w = d.getAncho();
    ...
    public static boolean puntoEnCuadrado(int px, int py, Bala d)
    {
        return px >= d.getX() &&
               px <= d.getX() + d.getAncho() &&
               py >= d.getY() &&
